...
#define IMUXC_ECSP3_SCLK_SELECT_INPUT      (*(volatile unsigned int *)0x20E0554)
#define IMUXC_ECSP3_MISO_SELECT_INPUT      (*(volatile unsigned int *)0x20E0558)
#define IMUXC_ECSP3_MOSI_SELECT_INPUT      (*(volatile unsigned int *)0x20E055C)
